    ...
    public function store(Request $req)
    {
        ...
        try {
            if(empty($req->key)){
                ...
                // Validation
                $key = str_replace("supplier", "", decrypt($req->key));
                $data = MsterSupplier::findOrFail($key);
